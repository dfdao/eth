...
contract DFStartFacet is WithStorage, WithArenaStorage {
    ...
    function start() public {
        ...
        gameConstants().MAX_NATURAL_PLANET_LEVEL = ai().initArgs.MAX_NATURAL_PLANET_LEVEL;
        gameConstants().TIME_FACTOR_HUNDREDTHS = ai().initArgs.TIME_FACTOR_HUNDREDTHS;
        ...
        gameConstants().PLANET_TRANSFER_ENABLED = ai().initArgs.PLANET_TRANSFER_ENABLED;
        gameConstants().PHOTOID_ACTIVATION_DELAY = ai().initArgs.PHOTOID_ACTIVATION_DELAY;
        gameConstants().LOCATION_REVEAL_COOLDOWN = ai().initArgs.LOCATION_REVEAL_COOLDOWN;
        ...
        gameConstants().ABANDON_SPEED_CHANGE_PERCENT = ai().initArgs.ABANDON_SPEED_CHANGE_PERCENT;
        gameConstants().ABANDON_RANGE_CHANGE_PERCENT = ai().initArgs.ABANDON_RANGE_CHANGE_PERCENT;
        // Capture Zones
        ...
        arenaConstants().CLAIM_VICTORY_ENERGY_PERCENT = ai().initArgs.CLAIM_VICTORY_ENERGY_PERCENT;
        ...
        arenaConstants().ARTIFACT_TYPE_PRICES = ai().initArgs.ARTIFACT_TYPE_PRICES;
        arenaConstants().ARTIFACT_RARITY_PRICES = ai().initArgs.ARTIFACT_RARITY_PRICES;
        arenaConstants().SPACESHIP_PRICES = ai().initArgs.SPACESHIP_PRICES;
